...
class FBF_FireplaceBase extends ItemBase
{
	...
	protected void RefreshFireParticlesAndSounds( bool force_refresh )
	{
		...
		{
			if ( fire_state == FBF_FireplaceFireState.START_FIRE )
			{
				//particles
			...
			else if ( fire_state == FBF_FireplaceFireState.SMALL_FIRE )
			{
				//particles
			...
			else if ( fire_state == FBF_FireplaceFireState.NORMAL_FIRE )
			{
				//particles
				ParticleFireStartStop();
			...
			else if ( fire_state == FBF_FireplaceFireState.END_FIRE )
			{
				//particles
				ParticleFireStartStop();
			...
			else if ( fire_state == FBF_FireplaceFireState.EXTINGUISHING_FIRE )		//TODO add steam particles when extinguishing
			{
				//particles
				ParticleFireStartStop();
			...
			else if ( fire_state == FBF_FireplaceFireState.EXTINGUISHED_FIRE )		//TODO add steam particles when fireplace is extinguished
			{
				//particles
				ParticleFireStartStop();
			...
			else if ( fire_state == FBF_FireplaceFireState.REIGNITED_FIRE )
			{
				//particles
				ParticleFireStartStart();
			...
			else if ( fire_state == FBF_FireplaceFireState.NO_FIRE )
			{
				//particles
				ParticleFireStartStop();
	...
	protected void Heating()
	{
		...
		*/
		...
		{
			StopFire( FBF_FireplaceFireState.EXTINGUISHED_FIRE );
			return; 
		}
		else
		{
