...
// class FBF_FireplaceBase extends ItemBase
// {
// 	//State params
...
// 	const float	PARAM_IGNITE_RAIN_THRESHOLD 		= 5.1;		//! maximum rain value when the fireplace can be ignited
...
// 	const float PARAM_FULL_HEAT_RADIUS 				= 1.5;		//! radius in which objects are fully heated by fire
// 	const float PARAM_HEAT_RADIUS 					= 6.0;		//! radius in which objects are heated by fire
// 	const float PARAM_HEAT_THROUGH_AIR_COEF			= 0.055;		//! DEPRECATED value for calculation of heat transfered from fireplace through air to player (environment)
...
// 	const float IGNITE_WIND_THRESHOLD				= 5.8; 		//fireplace can not be ignited above this multiple of max wind
...
// 	// Light entity
// 	protected FBF_FireplaceLight m_Light;
...
// 	//Particles - default for FBF_FireplaceBase
...
// 	protected ref FBF_UniversalTemperatureSourceLambdaFireplace m_UTSLFireplace;
	
// 	//================================================================
// 	// INIT / STORE LOAD-SAVE
// 	//================================================================
// 	//Constructor
// 	protected void FBF_FireplaceBase()
// 	{
...
// 			m_UTSLFireplace= new FBF_UniversalTemperatureSourceLambdaFireplace();
...
// 			if (!GetLightEntity())
// 			{
// 				SetLightEntity(FBF_FireplaceLight.Cast(ScriptedLightBase.CreateLight(FBF_FireplaceLight, GetPosition(), 20)));
...
// 	{
// 		FBF_FireplaceFireState fire_state = GetFireState();
		
// 		if ( m_LastFireState != fire_state || force_refresh )
// 		{
// 			switch ( fire_state )
// 			{
// 				case FBF_FireplaceFireState.START_FIRE:
// 				{
// 					//particles
...
// 					break;		
// 				}
// 				case FBF_FireplaceFireState.SMALL_FIRE:
// 				{
// 					//particles
...
// 					break;
// 				}
// 				case FBF_FireplaceFireState.NORMAL_FIRE:
// 				{
// 					//particles
// 					ParticleFireStartStop();
...
// 					break;
// 				}
// 				case FBF_FireplaceFireState.END_FIRE:
// 				{
// 					//particles
// 					ParticleFireStartStop();
...
// 					break;
// 				}
// 				case FBF_FireplaceFireState.EXTINGUISHING_FIRE:		//TODO add steam particles when extinguishing
// 				{
// 					//particles
// 					ParticleFireStartStop();
...
// 					break;			
// 				}
// 				case FBF_FireplaceFireState.EXTINGUISHED_FIRE:		//TODO add steam particles when fireplace is extinguished
// 				{
// 					//particles
// 					ParticleFireStartStop();
...
// 					break;
// 				}
// 				case FBF_FireplaceFireState.REIGNITED_FIRE:
// 				{
// 					//particles
// 					ParticleFireStartStart();
...
// 					break;
// 				}
// 				case FBF_FireplaceFireState.NO_FIRE:
// 				{
// 					//particles
// 					ParticleFireStartStop();
...
// 			{
// 				if ( GetFireState() != FBF_FireplaceFireState.START_FIRE )
// 				{
// 					SetFireState( FBF_FireplaceFireState.START_FIRE );
// 				}
// 			}
// 			//Small fire
// 			else if ( temperature >= PARAM_SMALL_FIRE_TEMPERATURE && temperature < PARAM_NORMAL_FIRE_TEMPERATURE )
// 			{
// 				if ( GetFireState() != FBF_FireplaceFireState.SMALL_FIRE )
// 				{
// 					SetFireState( FBF_FireplaceFireState.SMALL_FIRE );
// 				}
// 			}
// 			//Normal fire
// 			else if ( temperature > PARAM_SMALL_FIRE_TEMPERATURE )
// 			{
// 				if ( GetFireState() != FBF_FireplaceFireState.NORMAL_FIRE )
// 				{
// 					SetFireState( FBF_FireplaceFireState.NORMAL_FIRE );
// 				}
// 			}			
// 		}
// 	}
...
// 		if ( attached_item )
// 		{
// 			return attached_item.GetQuantity() > 0;
// 		}
...
// 	//Sets fire state
// 	protected void SetFireState( FBF_FireplaceFireState state )
// 	{
...
// 	{
// 		SetFireState( FBF_FireplaceFireState.EXTINGUISHING_FIRE );
// 	}
...
// 			m_NoisePar.LoadFromPath("CfgVehicles FBF_FireplaceBase NoiseFireplaceSpecial");
// 		else
// 			m_NoisePar.LoadFromPath("CfgVehicles FBF_FireplaceBase NoiseFBF_FireplaceBase");
// 	}
...
// 		//check fire state
// 		if ( GetFireState() != FBF_FireplaceFireState.EXTINGUISHING_FIRE )
// 		{
// 			RefreshFireState();
// 		}
...
// 	// 2. cooling
// 	// 3. stop cooling
// 	void StopFire( FBF_FireplaceFireState fire_state = FBF_FireplaceFireState.END_FIRE )
// 	{
// 		//Debug
// 		//PlayerBase player = ( PlayerBase ) GetGame().GetPlayer();
...
// 		if ( ingr )
// 		{
// 			m_CookingProcess.SmokeItem( ingr, FBF_FireplaceBase.TIMER_HEATING_UPDATE_INTERVAL * FBF_FireplaceBase.SMOKING_SPEED );
// 		}
// 	}
...
// 		float wind_speed_threshold = GetGame().GetWeather().GetWindMaximumSpeed() * FBF_FireplaceBase.IGNITE_WIND_THRESHOLD;
...
// 	{
// 		return FBF_FireplaceBase.IsEntityOnWaterSurface( this );
// 	}
...
// 	{
// 		return FBF_FireplaceBase.IsEntityOnInteriorSurface( this );
// 	}
...
// 			return ( !IsOven() && !IsBurning() && ( item_quantity >= MIN_STONES_TO_BUILD_OVEN ) && !FindAttachmentBySlotName( "CookingTripod" ) && !HasStoneCircle() && IsSpaceForOven() );
// 		}
...
// 	void SetLightEntity( FBF_FireplaceLight light )
// 	{
// 		m_Light = light;
// 	}
